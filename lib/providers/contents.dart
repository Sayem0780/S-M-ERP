...
class Contents extends ChangeNotifier{
  ...
  void updateCurrentRootKey(String newRootKey) {
   int index = int.parse(newRootKey);
    ...
    notifyListeners();
    print("rootkey: "+currentRootKey);// Notify listeners about the change
  }
  ...
  Future<void> creatpost(LC lcData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('LC data uploaded successfully!');
     _currentRootKey = responseData.substring(9,29);
      print(currentRootKey);
    } else {
      // Error handling - handle failed API request
      print('Failed to upload LC data');
    }
  }
  ...
  Future<void> createtChassis(Chassis chassis,String PostKey,String amount,String profit) async {
    try {
      ...
      if (response.statusCode == 200) {
        print("Chassis posted successfully");
        fetchAndPrintPosts();
        updateLcAmount(amount, PostKey);
        updateLcProfit(profit, PostKey);
        notifyListeners();
      } else {
        print("Failed to post chassis data. Status code: ${response.statusCode}");
  ...
  Future<void> deletePost(LC post, String RootKey,String keyNode,) async {

    try {
      final Url = Uri.parse('https://shop-624d0-default-rtdb.firebaseio.com/erp/$userName/lc/$RootKey/$keyNode.json');
  ...
  Future<void> creatQuotation(Quotation QData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Qutation Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for Quotation: $value');
          }
        });
  ...
  Future<void> creatBill(Bill BData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Bill Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          ...
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for bill: $value');
          }
        });
        return billdata;
      } else {
  ...
  Future<void> creatChallan(Challan CData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Challan Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for challan: $value');
          }
        });
  ...
  Future<void> creatCustomerReceipt(Custom CuData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Customer Receipt Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for customer receipt: $value');
          }
        });
  ...
  Future<void> creatBankReceipt(Bank BData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Bank Receipt Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for bank receipt: $value');
          }
        });
  ...
  Future<void> creatDirectCustomerReceipt(SaleCustom DCuData) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Failed to upload Direct Customer Receipt Report data');
    }
  }
      ...
      if (response.statusCode == 200) {
        ...
        data.forEach((key, value) {
          if (value != null && value is Map<String, dynamic>) {
            ...
            print('Invalid data structure for direct customer receipt: $value');
          }
        });
